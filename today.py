...
USER_NAME = os.environ["USER_NAME"]  # 'fiorentinjoao'
QUERY_COUNT = {
    "user_getter": 0,
    "follower_getter": 0,
    "graph_repos_stars": 0,
...
def daily_readme(since_date):
    """
    Returns the length of time since since_date (e.g. GitHub account creation)
...
if __name__ == "__main__":
    """
    Adapted from Andrew Grant's (Andrew6rant) profile README generator, 2022-2025
    """
